...
public class TransactionalityTest extends TestCase
{
	...
	public void testIllegalSet()
	{
		...
		{
			assertEquals("Setter setA without getter in interface transactionality.TransactionalityTest$Error2", e.getMessage());
		}
	}
	...
	public void testIllegalSet2()
	{
		...
		{
			assertEquals("Non-primitive setter setA in interface transactionality.TransactionalityTest$Error4", e.getMessage());
		}
	}
	...
	public void testIllegalCommands()
	{
		...
		{
			assertEquals("interface transactionality.TransactionalityTest$Error5 has illegal methods.", e.getMessage());
		}
	}
	...
	public void testIllegalDelete()
	{
		...
		{
			assertEquals("Delete without boolean return value: deleteA in interface transactionality.TransactionalityTest$Error6", e.getMessage());
		}
	}
